            ...
            <div class='absolute inset-0'>
                ...
                <div class='absolute inset-0 transition-all duration-1000 opacity-100' data-story-slide='0'>
                    <img src='/lib/images/site/hero-fusion.jpg' class='w-full h-full object-cover scale-110' 
                         onerror=\"if(this.src != 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&q=80&w=2000') this.src='https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&q=80&w=2000';\">
                </div>
                ...
                <div class='absolute inset-0 transition-all duration-1000 opacity-0' data-story-slide='1'>
                    <img src='/lib/images/site/hero-sovereignty.jpg' class='w-full h-full object-cover' 
                         onerror=\"if(this.src != 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=80&w=2000') this.src='https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=80&w=2000';\">
                </div>
                <!-- Slide 3: THE REVENUE -->
                <div class='absolute inset-0 transition-all duration-1000 opacity-0' data-story-slide='2'>
                    <img src='/lib/images/site/hero-revenue.jpg' class='w-full h-full object-cover' 
                         onerror=\"if(this.src != 'https://images.unsplash.com/photo-1553729459-efe14ef6055d?auto=format&fit=crop&q=80&w=2000') this.src='https://images.unsplash.com/photo-1553729459-efe14ef6055d?auto=format&fit=crop&q=80&w=2000';\">
                </div>
            </div>
            ...
            <div class='relative z-20 p-12 lg:p-24 min-h-[600px] flex items-center'>
                <div class='max-w-3xl'>
                    <div class='story-content transition-all duration-700 block' data-story-content='0'>
                        ...
                        <h1 class='text-6xl lg:text-8xl font-black mb-8 tracking-tighter leading-none'>MUSIC MEETS <br><span class='text-brand italic'>TERMINAL</span> VELOCITY</h1>
                    ...
                    <div class='story-content transition-all duration-700 hidden' data-story-content='2'>
                        <div class='inline-block px-3 py-1 bg-brand text-black font-black text-[10px] uppercase tracking-widest mb-6 rounded-sm'>Revenue</div>
