<?php
// JSON bridge: list labels from NGN 1.0 DB for NGN 2.0 preview
...
$sql = "SELECT id, slug, name, image_url FROM `ngn_2025`.`labels` {$where} ORDER BY name ASC LIMIT :lim OFFSET :off";
