<?php
// JSON bridge: list stations from NGN 1.0 DB for NGN 2.0 preview
...
$sql = "SELECT id, slug, name, image_url, region, format FROM `ngn_2025`.`stations` {$where} ORDER BY name ASC LIMIT :lim OFFSET :off";
