<?php
/**
 * Label Dashboard - Social Connections
...
if ($entity) {
    try {
        $pdo = dashboard_pdo();
        $stmt = $pdo->prepare("SELECT * FROM oauth_tokens WHERE entity_type = 'label' AND entity_id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['disconnect'])) {
    $provider = $_POST['disconnect'];
    if ($entity && dashboard_validate_csrf($_POST['csrf'] ?? '')) {
        try {
            $pdo = dashboard_pdo();
            $stmt = $pdo->prepare("DELETE FROM oauth_tokens WHERE entity_type = 'label' AND entity_id = ? AND provider = ?");
...
// Platform configurations for labels
$platforms = [
    'spotify' => [
        'name' => 'Spotify for Labels',
        'icon' => 'bi-spotify',
        'color' => '#1DB954',
        'description' => 'Connect to track your roster\'s streaming stats, playlist placements, and label performance.',
        'permissions' => ['Read label profile', 'View roster statistics', 'Access release analytics'],
    ],
    'facebook' => [
        'name' => 'Facebook',
        'icon' => 'bi-facebook',
        'color' => '#1877f2',
        'description' => 'Connect your Facebook Page to promote releases and track engagement.',
    ...
    'instagram' => [
        ...
        'icon' => 'bi-instagram',
        'color' => '#e4405f',
        'description' => 'Connect your Instagram Business account for label content and engagement metrics.',
    ...
    'tiktok' => [
        ...
        'icon' => 'bi-tiktok',
        'color' => '#000000',
        'description' => 'Connect TikTok to track viral moments and artist content performance.',
    ...
    'youtube' => [
        ...
        'icon' => 'bi-youtube',
        'color' => '#ff0000',
        'description' => 'Connect your YouTube channel for music video analytics and subscriber growth.',
...
<div class="main-content">
    <header class="page-header">
        ...
        <p class="page-subtitle">Connect your social accounts to boost your label's NGN Score</p>
    </header>
    ...
    <div class="page-content">
        ...
        <div class="alert alert-warning">
            ...
            Set up your label profile first to connect social accounts.
            ...
            <div class="grid grid-3">
                <div style="display: flex; gap: 12px; align-items: flex-start;">
                    ...
                    <div>
                        ...
                        <div style="font-size: 13px; color: var(--text-secondary);">Social metrics directly impact your label ranking</div>
                    </div>
                </div>
                <div style="display: flex; gap: 12px; align-items: flex-start;">
                    <i class="bi bi-vinyl" style="font-size: 24px; color: var(--accent);"></i>
                    <div>
                        <div style="font-weight: 600; margin-bottom: 4px;">Track Releases</div>
                        <div style="font-size: 13px; color: var(--text-secondary);">Monitor your roster's performance</div>
                    </div>
                </div>
                <div style="display: flex; gap: 12px; align-items: flex-start;">
                    ...
                    <div>
                        ...
                        <div style="font-size: 13px; color: var(--text-secondary);">Show artists your label's reach</div>
                    </div>
                </div>
            </div>
        </div>
