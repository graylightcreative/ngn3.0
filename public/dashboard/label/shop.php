<?php
/**
 * Label Dashboard - Shop & Merch Management
 */
...
// Fetch products
if ($entity) {
    $result = $productService->list('label', (int)$entity['id'], null, '', false);
    $products = $result['items'];
    
    if ($productId && $action === 'edit') {
        $editProduct = $productService->get($productId);
        // Security check: ensure product belongs to this entity
        if ($editProduct && ($editProduct['owner_type'] !== 'label' || (int)$editProduct['owner_id'] !== (int)$entity['id'])) {
            $editProduct = null;
...
<div class="main-content">
    ...
    <div class="page-content">
        ...
        <div class="alert alert-warning">
            ...
            Your label profile needs to be set up before you can manage your shop.
