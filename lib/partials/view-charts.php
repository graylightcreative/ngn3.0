...
<div class="mb-12">
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
        <div>
            <div class="inline-block px-3 py-1 bg-brand text-black font-black text-[10px] uppercase tracking-widest mb-4 rounded-sm">Institutional_Intelligence</div>
        ...
        <div class="flex bg-zinc-900 p-1 rounded-2xl border border-white/5">
            <a href="/charts?type=artists" class="px-8 py-3 rounded-xl text-xs font-black uppercase tracking-widest transition-all <?= $chartType === 'artists' ? 'bg-brand text-black shadow-xl shadow-brand/20' : 'text-zinc-500 hover:text-white' ?>">Artists</a>
            <a href="/charts?type=labels" class="px-8 py-3 rounded-xl text-xs font-black uppercase tracking-widest transition-all <?= $chartType === 'labels' ? 'bg-brand text-black shadow-xl shadow-brand/20' : 'text-zinc-500 hover:text-white' ?>">Labels</a>
        </div>
    </div>
