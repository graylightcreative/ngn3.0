...
namespace NextGenNoise\Lib\Charts;
...
class SMRChart
{
    ...
    public function handleArtistsandSong($artistAndSong)
    {
    ...
    public function getWeekStartEndDates($filename)
    {
    ...
    public function handleSMRLabels($labels)
    {
        // labels is a string
        // LABEL/LABEL
        // OR LABEL
    ...
    public function getDecayedSMRData()
    {
        global $pdo;
